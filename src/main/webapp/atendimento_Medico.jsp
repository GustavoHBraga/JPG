...
<html>
    <head>
        ...
        <script>
            ...
            var ws = new WebSocket(wsUrl + window.location.host + "/JPG/atendimentoMedico");
            ...
            <center>
                <div>
                    ...
                    <div class="container">
                        ...
                        <br>
                        <a href="triagens.jsp"><button class="btn-5" style="font-size: 12px; color: salmon;">Finalizar</button></a>
                    </div>
                </div>
            </center>
        </div>
