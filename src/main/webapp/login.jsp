    ...
    <body class="align">
        ...
        <form action="login.jsp" method="post" class="form login">
            ...
            <div class="form__field">
                ...
                <p class="text--center">É trabalhista da instituição e não possui conta? <a href="registros.jsp"><b>Cadastre-se</b></a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
            </div>
