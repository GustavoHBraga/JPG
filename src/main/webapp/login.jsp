...
<html>
    ...
    <body class="align">
        ...
        <p class="text--center" style="color: #4E5066">É paciente e deseja realizar uma consulta ? acesse nosso <a href="formulario_paciente.jsp"><b>Formulário de Triagem</b></a>
            <br>
