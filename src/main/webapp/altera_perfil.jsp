...
<html>
    ...
    <body class="align">
        ...
        <div class="grid">
            ...
            <p class="text--center"><a href="PerfilServlet" style="color: #4E5066">Cancelar</a><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
        </div>
