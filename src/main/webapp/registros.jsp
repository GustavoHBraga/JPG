...
<html>
    <head>
        ...
        <script type="text/javascript" src="lib/js/validaRegistro.js"></script>
    </head>
    <body class="align">
        ...
        <div class="grid">
            <form action="RegistrosServlet" method="post" class="form login" name="formRegistro">
                ...
                <div class="form__field">
                    ...
                    <input id="login__username" type="text" name="nome" class="form__input" placeholder="Nome completo *" required>
                </div>
                <div class="form__field">
                ...
                <div class="form__field">
                    ...
                    <input id="login__password" type="password" name="senhaRepitida" class="form__input" placeholder="Repita sua senha *" required>
                </div>
                <div style="color: #4E5066">
                    &nbsp;&nbsp;&nbsp;
                    <input id="login__username" type="checkbox" name="confirmTrabalho" class="form__input" required>
                    Sou médico trabalhista da instituição e tenho <br>
            ...
            <p class="text--center" style="color: #4E5066">Já é cadastrado ? <a href="login.jsp" style="color: #4E5066"><b>Acesse</b></a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
        </div>
